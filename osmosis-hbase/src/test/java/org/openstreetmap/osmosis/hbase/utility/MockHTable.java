...
/**
 * org.openstreetmap.osmosis.hbase.utility.MockHTable.
 *
 * original org.openstreetmap.osmosis.hbase.utility.MockHTable (by agaoglu) : https://gist.github.com/agaoglu/613217#file_mock_h_table.java
...
//        return incrementColumnValue(row, family, qualifier, amount);
    ...
    @Override
    public <T extends Service, R> Map<byte[], R> coprocessorService(Class<T> var1, byte[] var2, byte[] var3, Batch.Call<T, R> var4) throws Throwable {
        throw new RuntimeException(this.getClass() + " does NOT implement this method.");
    }

    @Override
    public <T extends Service, R> void coprocessorService(Class<T> var1, byte[] var2, byte[] var3, Batch.Call<T, R> var4, Batch.Callback<R> var5) throws Throwable {
        throw new RuntimeException(this.getClass() + " does NOT implement this method.");
    }
    ...
    @Override
    public <R extends Message> Map<byte[], R> batchCoprocessorService(Descriptors.MethodDescriptor var1, Message var2, byte[] var3, byte[] var4, R var5) throws Throwable {
        throw new RuntimeException(this.getClass() + " does NOT implement this method.");
    }

    @Override
    public <R extends Message> void batchCoprocessorService(Descriptors.MethodDescriptor var1, Message var2, byte[] var3, byte[] var4, R var5, Batch.Callback<R> var6) throws Throwable {
        throw new RuntimeException(this.getClass() + " does NOT implement this method.");
    }
